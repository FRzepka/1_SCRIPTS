...
\begin{figure*}[t]
    \centering
    \benchfig{../../../DL_Models/LFP_SOC_SOH_Model/4_simulation_environment/results/paper_figures_v4_adc_extension/Figure_ADC_quantization_v4.png}{ADC-quantization appendix figure missing.}
