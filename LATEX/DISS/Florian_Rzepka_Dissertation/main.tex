...
\section{Structure of the Research and Development Path}
Chapter~\ref{chap:foundations} introduces the battery, BMS, state-estimation, machine-learning, and embedded-AI foundations required by the later studies. Chapter~\ref{chap:experimental} describes the two datasets, the construction of the reference quantities, the embedded targets, and the Custom BMS Platform. Chapters~\ref{chap:ageing} to~\ref{chap:embedded} contain the three technical contributions. Chapter~\ref{chap:synthesis} combines the general discussion, overall conclusion, remaining gaps, and outlook. The requirement framework in Figure~\ref{fig:bms_requirements} is revisited in this final synthesis rather than repeated as a separate introductory chapter.

\begin{table}[H]
    \centering
    \small
    \setlength{\tabcolsep}{3.5pt}
    \caption[Research structure and publication basis.]{Structure of the research, function of the contribution chapters, and associated publication basis.}
    \label{tab:publication_map}
    \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{1.35cm}>{\raggedright\arraybackslash}p{4.2cm}>{\raggedright\arraybackslash}p{3.3cm}>{\raggedright\arraybackslash}X}
        \toprule
        Chapter & Role & Primary dimension & Publication basis \\
        \midrule
        \ref{chap:experimental} & Experimental and hardware basis & Data, labels, and validation context & Shared basis for all three contribution studies \\
        \ref{chap:ageing} & Ageing estimation for stationary storage & Representation design and SOH estimation & Published journal article\autocite{rzepkaNeuralNetworkArchitecture2023a} \\
        \ref{chap:robustness} & Robustness benchmark for battery-state estimation & Disturbed-operation performance & Manuscript submitted to the \emph{Journal of Energy Storage}\autocite{rzepkaPerformanceBenchmarkSubmitted2026} \\
        \ref{chap:embedded} & Embedded AI for SOC and SOH estimation & Deployment and compression & SSRN preprint\autocite{rzepkaEmbeddedArtificialIntelligence2026} \\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \node[base] (foundation) at (0,0) {\textbf{Technical and experimental basis:} battery and BMS foundations, datasets, reference quantities, embedded targets, and the Custom BMS Platform.};
        \node[topic] (p1) at (-4.8,2.8) {\textbf{Chapter \ref{chap:ageing}}\\Ageing estimation\\published study};
        \node[topic] (p3) at (0,2.8) {\textbf{Chapter \ref{chap:robustness}}\\Robustness benchmark\\submitted manuscript};
        \node[topic] (p2) at (4.8,2.8) {\textbf{Chapter \ref{chap:embedded}}\\Embedded AI\\SSRN preprint};
        \node[synth] (synthesis) at (0,5.6) {\textbf{Chapter \ref{chap:synthesis}:} integrated discussion, deployment-oriented design lessons, conclusion, and outlook.};
    ...
    \caption[Overall work roadmap.]{Roadmap from the shared basis to the three contribution studies and their integrated synthesis. Chapters~\ref{chap:ageing} to~\ref{chap:embedded} correspond to a published study, a submitted manuscript, and an SSRN preprint.\autocite{rzepkaNeuralNetworkArchitecture2023a,rzepkaPerformanceBenchmarkSubmitted2026,rzepkaEmbeddedArtificialIntelligence2026}}
