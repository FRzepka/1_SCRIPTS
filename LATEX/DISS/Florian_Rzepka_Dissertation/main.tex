...
\begin{figure}[H]
    ...
    \caption[Correlation heatmap for SOH-related input variables.]{Correlation heatmap illustrating the linear relation between SOH and candidate input variables, including temperature and cumulative current $Q$ in positive and negative direction. The continuous sRGB scale maps negative correlations to blue and positive correlations to red, with the direct blue-red mixture representing zero. The exact coefficient is printed in each cell.}
