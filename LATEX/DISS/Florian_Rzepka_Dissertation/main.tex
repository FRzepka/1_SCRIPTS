...
\begin{figure}[H]
    ...
    \caption[Correlation heatmap for SOH-related input variables.]{Correlation heatmap illustrating the linear relation between SOH and candidate input variables, including temperature and cumulative current $Q$ in positive and negative direction. Red intensity represents the absolute magnitude of the correlation, with white corresponding to zero and dark red to either $-1$ or $+1$. The sign and exact value are given by the coefficient printed in each cell.}
