...
HIDDEN_SIZE         = 64       # Version 2.1.4.2 - Option B: 64
MLP_HIDDEN          = 64       # Version 2.1.4.2 - Option B: 64
BATCH_SIZE          = 4        # Mehrere Windows parallel verarbeiten
VERSION             = "2.1.4.2"  # Version identifier

# Gerät auswählen und cuDNN optimieren
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
torch.backends.cudnn.benchmark = True
print(f"Using device: {device}")
print(f"🚀 BMS SOC LSTM Version {VERSION} - Option B (64→64→64→1)")
