...
class ModelArchitectureAnalyzer:
    ...
    def create_arduino_memory_estimation_visualization(self):
        ...
        ax2.scatter(real_hs, real_ram_vals, color=real_ram_color, s=200, marker='^',
                   label='RAM Real Measurements', zorder=5, edgecolors='black', linewidth=2)        # Arduino limits as horizontal lines - elegant colors from mint_blue diagram
        ...
        if estimation_data:
            ...
            labels = [label.replace('_', ' ').title() for label in ram_components.keys()]            # Use elegant colors from mint_blue diagram for RAM
