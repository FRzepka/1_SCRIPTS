...
def extract_weights(model_path, output_header_path):
    ...
    os.makedirs(os.path.dirname(output_header_path), exist_ok=True)    with open(output_header_path, "w") as f:
...
if __name__ == "__main__":
    ...
    print(f"Bitte führe dieses Skript aus, um die lstm_weights.h zu generieren:\\\\npython {os.path.abspath(__file__)}")
