...
class ArduinoLSTMSOCPredictor:
    ...
    def read_arduino_response(self, timeout=2.0):
        ...
        logger.warning("⚠️ Arduino Timeout - keine Antwort erhalten")
        return None
    ...
    def reset_arduino_lstm(self):
        ...
        if response and "RESET" in response:
            ...
            logger.warning("⚠️ Arduino Reset nicht bestätigt")
    ...
    def load_scaler(self):
        ...
        try:
            ...
            if scaler_path.exists():
                ...
                logger.warning("⚠️ Gespeicherter Scaler nicht gefunden, erstelle neuen basierend auf Daten...")
    ...
    def setup_plots(self):
        ...
        logger.info("📊 Live Plotting Setup abgeschlossen")
    ...
    def update_plots(self):
        ...
        try:
            ...
            logger.warning(f"⚠️ Plot Update Fehler: {e}")
    ...
    def run_infinite_prediction(self, delay_ms=20):
        ...
        try:
            ...
            logger.info(f"♾️ Infinite Mode gestartet mit {delay_ms}ms delay")
            ...
            while True:
                try:
                    ...
                    if predicted_soc is not None:
                        ...
                        logger.warning(f"⚠️ Sample #{sample_count}: Arduino Prediction fehlgeschlagen")
