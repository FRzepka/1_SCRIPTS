#!/usr/bin/env python3
"""
Parametric Arduino Memory Usage Calculator

Geben Sie LSTM- und MLP-Head-Konfigurationen als Parameter ein, um
RAM- und Flash-Verbrauchs-Schätzungen zu erhalten.
"""
import numpy as np
...
MLP_SIZES               = [32, 32, 1]   # MLP head layer sizes
...
def main():
    ...
    h = HIDDEN_SIZE
    mlp = MLP_SIZES
    print(f"Configuration: LSTM hidden_size={h}, MLP={mlp}")
