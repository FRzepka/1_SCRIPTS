...
def predict_soh_hourly(df_raw: pd.DataFrame, base_features: List[str], interval_seconds: int, feature_aggs: List[str],
                       scaler: RobustScaler, model: SOH_GRU_Seq2Seq, device: torch.device, soh_init: float = 1.0) -> Tuple[np.ndarray, np.ndarray]:
...
def main():
    ap = argparse.ArgumentParser(description="Run SOC+SOH scenario for SOC_1.6.0.0 + SOH_GRU_0.3.1.2")
    ...
    # model paths
    ap.add_argument("--soc_config", default="/home/florianr/MG_Farm/1_Scripts/DL_Models/LFP_SOC_SOH_Model/2_models/SOC_1.6.0.0/train_soc.yaml")
    ap.add_argument("--soc_ckpt", default="/home/florianr/MG_Farm/1_Scripts/DL_Models/LFP_SOC_SOH_Model/2_models/SOC_1.6.0.0/soc_epoch0005_rmse0.01393.pt")
    ap.add_argument("--soc_scaler", default="/home/florianr/MG_Farm/1_Scripts/DL_Models/LFP_SOC_SOH_Model/2_models/SOC_1.6.0.0/scaler_robust.joblib")
    ...
    summary = {
        'model': 'SOC_SOH_1.6.0.0_GRU_0.3.1.2',
        'cell': args.cell,
