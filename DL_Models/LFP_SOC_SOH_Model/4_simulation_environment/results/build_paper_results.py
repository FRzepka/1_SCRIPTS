...
LOCAL_ANALYSIS_DIR = ROOT / "analysis_local_focus" / "2026-03-12_local_recovery"
MODEL_DIRS = {
...
EXTRA_RUNS = {
    ("SOC_SOH_1.6.0.0_GRU_0.3.1.2", "initial_soc_error"): ROOT
    / "SOC_SOH_1.6.0.0_0.1.2.3"
    / "runs"
    / "initial_soc_error"
    / "2026-03-12_1110_initial_soc_error_proxy_m10_fix",
}
...
def main() -> None:
    ...
    (RESULTS_DIR / "results_manifest.json").write_text(json.dumps(summary, indent=2))
