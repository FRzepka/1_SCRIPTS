...
SCENARIOS = [
    ...
    ("current_offset_neg_50mA", "current_offset", ["--current_offset_a", "-0.050"]),
    ("current_offset_pos_50mA", "current_offset", ["--current_offset_a", "0.050"]),
...
SCENARIO_LABELS = {
    ...
    "current_bias_0p5pct": "Current-gain error (0.5%)",
    "current_bias_1p5pct": "Current-gain error (1.5%)",
    "current_bias_3p0pct": "Current-gain error (3.0%)",
    "current_offset_neg_50mA": "Current offset (-50 mA)",
    "current_offset_pos_50mA": "Current offset (+50 mA)",
