...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "soh_cnn_converted_perchannel_quant_int8_int8_calibration_data_keras_npz_1"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0xc6577e8907a23cd1253b78e85f5c87cc"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x6cc935be8e5ef0af)
...
#define STAI_NETWORK_MACC_NUM            (48600001)

/*  Macros to declare input buffers characteristics  */
#define STAI_NETWORK_IN_NUM              (1)
#define STAI_NETWORK_IN_SIZE_BYTES       (1924)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,96,20}
...
#define STAI_NETWORK_IN_1_SIZE        (1920)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (1920)
#define STAI_NETWORK_IN_1_SCALE       (0.07195434719324112f)
#define STAI_NETWORK_IN_1_ZERO_POINT  (40)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_NETWORK_OUT_NUM             (1)
#define STAI_NETWORK_OUT_SIZE_BYTES      (100)
...
#define STAI_NETWORK_OUT_1_SHAPE       {1,96,1,1}
...
#define STAI_NETWORK_OUT_1_SIZE        ((96 * 1 * 1))
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (96)
#define STAI_NETWORK_OUT_1_SCALE       (0.003846552222967148f)
#define STAI_NETWORK_OUT_1_ZERO_POINT  (-128)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (90448)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (90448)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (90448)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (90448)
#define STAI_NETWORK_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_NETWORK_WEIGHTS_NUM                  (19)
#define STAI_NETWORK_WEIGHTS_SIZE                  (1488196)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (1488196)
#define STAI_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4}
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 128,128,128,128,2560,512,81920,512,81920,512,327680,512,327680,327680,327680,8192,256,64,4}
#define STAI_NETWORK_WEIGHTS_NUM        (19)
#define STAI_NETWORK_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_1_SIZE        (128)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (128)
...
#define STAI_NETWORK_WEIGHT_3_SIZE        (128)
#define STAI_NETWORK_WEIGHT_3_SIZE_BYTES  (128)
...
#define STAI_NETWORK_WEIGHT_5_SIZE        (2560)
#define STAI_NETWORK_WEIGHT_5_SIZE_BYTES  (2560)
#define STAI_NETWORK_WEIGHT_6_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_6_SIZE        (512)
#define STAI_NETWORK_WEIGHT_6_SIZE_BYTES  (512)
#define STAI_NETWORK_WEIGHT_7_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_7_SIZE        (81920)
#define STAI_NETWORK_WEIGHT_7_SIZE_BYTES  (81920)
...
#define STAI_NETWORK_WEIGHT_9_SIZE        (81920)
#define STAI_NETWORK_WEIGHT_9_SIZE_BYTES  (81920)
#define STAI_NETWORK_WEIGHT_10_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_10_SIZE        (512)
#define STAI_NETWORK_WEIGHT_10_SIZE_BYTES  (512)
#define STAI_NETWORK_WEIGHT_11_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_11_SIZE        (327680)
#define STAI_NETWORK_WEIGHT_11_SIZE_BYTES  (327680)
#define STAI_NETWORK_WEIGHT_12_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_12_SIZE        (512)
#define STAI_NETWORK_WEIGHT_12_SIZE_BYTES  (512)
#define STAI_NETWORK_WEIGHT_13_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_13_SIZE        (327680)
#define STAI_NETWORK_WEIGHT_13_SIZE_BYTES  (327680)
#define STAI_NETWORK_WEIGHT_14_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_14_SIZE        (327680)
#define STAI_NETWORK_WEIGHT_14_SIZE_BYTES  (327680)
#define STAI_NETWORK_WEIGHT_15_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_15_SIZE        (327680)
#define STAI_NETWORK_WEIGHT_15_SIZE_BYTES  (327680)
#define STAI_NETWORK_WEIGHT_16_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_16_SIZE        (8192)
#define STAI_NETWORK_WEIGHT_16_SIZE_BYTES  (8192)
#define STAI_NETWORK_WEIGHT_17_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_17_SIZE        (256)
#define STAI_NETWORK_WEIGHT_17_SIZE_BYTES  (256)
#define STAI_NETWORK_WEIGHT_18_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_18_SIZE        (64)
#define STAI_NETWORK_WEIGHT_18_SIZE_BYTES  (64)
