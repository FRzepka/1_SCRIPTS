...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "soh_tcn_converted_perchannel_quant_int8_int8_calibration_data_keras_120_npz_1"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x60ceb04812f35cec7b27dcb14adf84ee"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x0361204ccbc36f5b)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,120,20}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_HEIGHT      (120)
#define STAI_NETWORK_IN_1_CHANNEL     (20)
#define STAI_NETWORK_IN_1_RANK        (2)
#define STAI_NETWORK_IN_1_SIZE        (2400)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (2400)
#define STAI_NETWORK_IN_1_SCALE       (0.10564419627189636f)
#define STAI_NETWORK_IN_1_ZERO_POINT  (45)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (121888)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (121888)
#define STAI_NETWORK_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_NETWORK_WEIGHTS_NUM                  (27)
#define STAI_NETWORK_WEIGHTS_SIZE                  (1547396)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (1547396)
#define STAI_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4}
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 96,96,96,96,96,96,96,96,1920,384,9600,384,46080,384,184320,384,184320,184320,184320,184320,184320,184320,184320,12288,512,128,4}
#define STAI_NETWORK_WEIGHTS_NUM        (27)
#define STAI_NETWORK_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_1_SIZE        (96)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (96)
...
#define STAI_NETWORK_WEIGHT_3_SIZE        (96)
#define STAI_NETWORK_WEIGHT_3_SIZE_BYTES  (96)
#define STAI_NETWORK_WEIGHT_4_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_4_SIZE        (96)
#define STAI_NETWORK_WEIGHT_4_SIZE_BYTES  (96)
#define STAI_NETWORK_WEIGHT_5_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_5_SIZE        (96)
#define STAI_NETWORK_WEIGHT_5_SIZE_BYTES  (96)
#define STAI_NETWORK_WEIGHT_6_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_6_SIZE        (96)
#define STAI_NETWORK_WEIGHT_6_SIZE_BYTES  (96)
#define STAI_NETWORK_WEIGHT_7_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_7_SIZE        (96)
#define STAI_NETWORK_WEIGHT_7_SIZE_BYTES  (96)
...
#define STAI_NETWORK_WEIGHT_9_SIZE        (1920)
#define STAI_NETWORK_WEIGHT_9_SIZE_BYTES  (1920)
#define STAI_NETWORK_WEIGHT_10_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_10_SIZE        (384)
#define STAI_NETWORK_WEIGHT_10_SIZE_BYTES  (384)
#define STAI_NETWORK_WEIGHT_11_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_11_SIZE        (9600)
#define STAI_NETWORK_WEIGHT_11_SIZE_BYTES  (9600)
...
#define STAI_NETWORK_WEIGHT_13_SIZE        (46080)
#define STAI_NETWORK_WEIGHT_13_SIZE_BYTES  (46080)
...
#define STAI_NETWORK_WEIGHT_15_SIZE        (184320)
#define STAI_NETWORK_WEIGHT_15_SIZE_BYTES  (184320)
#define STAI_NETWORK_WEIGHT_16_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_16_SIZE        (384)
#define STAI_NETWORK_WEIGHT_16_SIZE_BYTES  (384)
#define STAI_NETWORK_WEIGHT_17_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_17_SIZE        (184320)
#define STAI_NETWORK_WEIGHT_17_SIZE_BYTES  (184320)
#define STAI_NETWORK_WEIGHT_18_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_18_SIZE        (184320)
#define STAI_NETWORK_WEIGHT_18_SIZE_BYTES  (184320)
#define STAI_NETWORK_WEIGHT_19_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_19_SIZE        (184320)
#define STAI_NETWORK_WEIGHT_19_SIZE_BYTES  (184320)
#define STAI_NETWORK_WEIGHT_20_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_20_SIZE        (184320)
#define STAI_NETWORK_WEIGHT_20_SIZE_BYTES  (184320)
#define STAI_NETWORK_WEIGHT_21_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_21_SIZE        (184320)
#define STAI_NETWORK_WEIGHT_21_SIZE_BYTES  (184320)
#define STAI_NETWORK_WEIGHT_22_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_22_SIZE        (184320)
#define STAI_NETWORK_WEIGHT_22_SIZE_BYTES  (184320)
#define STAI_NETWORK_WEIGHT_23_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_23_SIZE        (184320)
#define STAI_NETWORK_WEIGHT_23_SIZE_BYTES  (184320)
#define STAI_NETWORK_WEIGHT_24_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_24_SIZE        (12288)
#define STAI_NETWORK_WEIGHT_24_SIZE_BYTES  (12288)
