...
#define STAI_MNETWORK_IN_3_SIZE_BYTES 4
#define STAI_MNETWORK_IN_3_SIZE 1
#define STAI_MNETWORK_IN_4_SIZE_BYTES 4
#define STAI_MNETWORK_IN_4_SIZE 1
#define STAI_MNETWORK_IN_5_SIZE_BYTES 4
#define STAI_MNETWORK_IN_5_SIZE 1
...
STAI_ALIGNED(32) static uint8_t data_in_3[STAI_MNETWORK_IN_3_SIZE_BYTES]; \
STAI_ALIGNED(32) static uint8_t data_in_4[STAI_MNETWORK_IN_4_SIZE_BYTES]; \
STAI_ALIGNED(32) static uint8_t data_in_5[STAI_MNETWORK_IN_5_SIZE_BYTES]; \
stai_ptr data_ins[] = { \
  data_in_1, \
  data_in_2, \
  data_in_3, \
...
#define STAI_MNETWORK_OUT_NUM 5
#define STAI_MNETWORK_OUT_1_SIZE_BYTES 4
#define STAI_MNETWORK_OUT_1_SIZE 1
#define STAI_MNETWORK_OUT_2_SIZE_BYTES 4
#define STAI_MNETWORK_OUT_2_SIZE 1
#define STAI_MNETWORK_OUT_3_SIZE_BYTES 4
#define STAI_MNETWORK_OUT_3_SIZE 1
#define STAI_MNETWORK_OUT_4_SIZE_BYTES 4
#define STAI_MNETWORK_OUT_4_SIZE 1
#define STAI_MNETWORK_OUT_5_SIZE_BYTES 4
#define STAI_MNETWORK_OUT_5_SIZE 1

#define DEF_DATA_OUT \
STAI_ALIGNED(32) static uint8_t data_out_1[STAI_MNETWORK_OUT_1_SIZE_BYTES]; \
STAI_ALIGNED(32) static uint8_t data_out_2[STAI_MNETWORK_OUT_2_SIZE_BYTES]; \
STAI_ALIGNED(32) static uint8_t data_out_3[STAI_MNETWORK_OUT_3_SIZE_BYTES]; \
STAI_ALIGNED(32) static uint8_t data_out_4[STAI_MNETWORK_OUT_4_SIZE_BYTES]; \
STAI_ALIGNED(32) static uint8_t data_out_5[STAI_MNETWORK_OUT_5_SIZE_BYTES]; \
stai_ptr data_outs[] = { \
  data_out_1, \
  data_out_2, \
  data_out_3, \
