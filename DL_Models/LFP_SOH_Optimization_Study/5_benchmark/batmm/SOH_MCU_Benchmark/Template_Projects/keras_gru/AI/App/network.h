...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "soh_lstm_unrolled_int8"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x4197bec152cdfe97d50c422d3062c212"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x512b5a2a4e65df99)
...
#define STAI_NETWORK_NODES_NUM           (146)

/*  Macro to declare number macc for generated network model  */
#define STAI_NETWORK_MACC_NUM            (913696)

/*  Macros to declare input buffers characteristics  */
#define STAI_NETWORK_IN_NUM              (5)
#define STAI_NETWORK_IN_SIZE_BYTES       (792)
...
#define STAI_NETWORK_IN_FORMATS \
  { STAI_FORMAT_S8, STAI_FORMAT_S8, STAI_FORMAT_S8, STAI_FORMAT_S8, STAI_FORMAT_S8}
...
#define STAI_NETWORK_IN_1_SHAPE       {1,1,20}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_HEIGHT      (1)
#define STAI_NETWORK_IN_1_CHANNEL     (20)
#define STAI_NETWORK_IN_1_RANK        (2)
#define STAI_NETWORK_IN_1_SIZE        (20)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (20)
#define STAI_NETWORK_IN_1_SCALE       (0.05971222743391991f)
#define STAI_NETWORK_IN_1_ZERO_POINT  (37)
...
#define STAI_NETWORK_IN_2_SHAPE       {1,192}
#define STAI_NETWORK_IN_2_BATCH       (1)
#define STAI_NETWORK_IN_2_CHANNEL     (192)
#define STAI_NETWORK_IN_2_RANK        (1)
#define STAI_NETWORK_IN_2_SIZE        (192)
#define STAI_NETWORK_IN_2_SIZE_BYTES  (192)
#define STAI_NETWORK_IN_2_SCALE       (0.005003895610570908f)
#define STAI_NETWORK_IN_2_ZERO_POINT  (5)

#define STAI_NETWORK_IN_3_ALIGNMENT   4
#define STAI_NETWORK_IN_3_NAME        (NULL)
#define STAI_NETWORK_IN_3_FLAGS       (STAI_FLAG_INPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_IN_3_FORMAT      (STAI_FORMAT_S8)
#define STAI_NETWORK_IN_3_SHAPE       {1,192}
#define STAI_NETWORK_IN_3_BATCH       (1)
#define STAI_NETWORK_IN_3_CHANNEL     (192)
#define STAI_NETWORK_IN_3_RANK        (1)
#define STAI_NETWORK_IN_3_SIZE        (192)
#define STAI_NETWORK_IN_3_SIZE_BYTES  (192)
#define STAI_NETWORK_IN_3_SCALE       (0.04996602237224579f)
#define STAI_NETWORK_IN_3_ZERO_POINT  (13)

#define STAI_NETWORK_IN_4_ALIGNMENT   4
#define STAI_NETWORK_IN_4_NAME        (NULL)
#define STAI_NETWORK_IN_4_FLAGS       (STAI_FLAG_INPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_IN_4_FORMAT      (STAI_FORMAT_S8)
#define STAI_NETWORK_IN_4_SHAPE       {1,192}
#define STAI_NETWORK_IN_4_BATCH       (1)
#define STAI_NETWORK_IN_4_CHANNEL     (192)
#define STAI_NETWORK_IN_4_RANK        (1)
#define STAI_NETWORK_IN_4_SIZE        (192)
#define STAI_NETWORK_IN_4_SIZE_BYTES  (192)
#define STAI_NETWORK_IN_4_SCALE       (0.007734459359198809f)
#define STAI_NETWORK_IN_4_ZERO_POINT  (0)

#define STAI_NETWORK_IN_5_ALIGNMENT   4
#define STAI_NETWORK_IN_5_NAME        (NULL)
#define STAI_NETWORK_IN_5_FLAGS       (STAI_FLAG_INPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_IN_5_FORMAT      (STAI_FORMAT_S8)
#define STAI_NETWORK_IN_5_SHAPE       {1,192}
#define STAI_NETWORK_IN_5_BATCH       (1)
#define STAI_NETWORK_IN_5_CHANNEL     (192)
#define STAI_NETWORK_IN_5_RANK        (1)
#define STAI_NETWORK_IN_5_SIZE        (192)
#define STAI_NETWORK_IN_5_SIZE_BYTES  (192)
#define STAI_NETWORK_IN_5_SCALE       (0.09746155887842178f)
#define STAI_NETWORK_IN_5_ZERO_POINT  (19)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_NETWORK_OUT_NUM             (5)
#define STAI_NETWORK_OUT_SIZE_BYTES      (776)
...
#define STAI_NETWORK_OUT_1_SHAPE       {1,192}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_CHANNEL     (192)
#define STAI_NETWORK_OUT_1_RANK        (1)
#define STAI_NETWORK_OUT_1_SIZE        ((192))
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (192)
#define STAI_NETWORK_OUT_1_SCALE       (0.09746155142784119f)
#define STAI_NETWORK_OUT_1_ZERO_POINT  (19)
...
#define STAI_NETWORK_OUT_2_SHAPE       {1,192}
#define STAI_NETWORK_OUT_2_BATCH       (1)
#define STAI_NETWORK_OUT_2_CHANNEL     (192)
#define STAI_NETWORK_OUT_2_RANK        (1)
#define STAI_NETWORK_OUT_2_SIZE        ((192))
#define STAI_NETWORK_OUT_2_SIZE_BYTES  (192)
#define STAI_NETWORK_OUT_2_SCALE       (0.005003895610570908f)
...
#define STAI_NETWORK_OUT_3_SHAPE       {1,192}
#define STAI_NETWORK_OUT_3_BATCH       (1)
#define STAI_NETWORK_OUT_3_CHANNEL     (192)
#define STAI_NETWORK_OUT_3_RANK        (1)
#define STAI_NETWORK_OUT_3_SIZE        ((192))
#define STAI_NETWORK_OUT_3_SIZE_BYTES  (192)
#define STAI_NETWORK_OUT_3_SCALE       (0.007734459359198809f)
...
#define STAI_NETWORK_OUT_4_SHAPE       {1,1,1}
...
#define STAI_NETWORK_OUT_4_SIZE        ((1 * 1))
#define STAI_NETWORK_OUT_4_SIZE_BYTES  (1)
#define STAI_NETWORK_OUT_4_SCALE       (0.004383135586977005f)
#define STAI_NETWORK_OUT_4_ZERO_POINT  (-128)
...
#define STAI_NETWORK_OUT_5_SHAPE       {1,192}
#define STAI_NETWORK_OUT_5_BATCH       (1)
#define STAI_NETWORK_OUT_5_CHANNEL     (192)
#define STAI_NETWORK_OUT_5_RANK        (1)
#define STAI_NETWORK_OUT_5_SIZE        ((192))
#define STAI_NETWORK_OUT_5_SIZE_BYTES  (192)
#define STAI_NETWORK_OUT_5_SCALE       (0.04996602237224579f)
#define STAI_NETWORK_OUT_5_ZERO_POINT  (13)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (10964)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (10964)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (10964)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (10964)
#define STAI_NETWORK_ACTIVATION_1_ALIGNMENT  4
/*  Macros to declare weights buffers characteristics  */

#define STAI_NETWORK_WEIGHTS_NUM                  (45)
#define STAI_NETWORK_WEIGHTS_SIZE                  (903068)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (903068)
...
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 4,192,192,192,192,192,192,192,192,768,147456,3072,768,147456,160,160,3200,640,4,4,25600,640,122880,4,147456,4,4,36864,768,36864,768,36864,768,36864,768,36864,768,36864,768,36864,768,36864,768,192,4}
#define STAI_NETWORK_WEIGHTS_NUM        (45)
#define STAI_NETWORK_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_1_SIZE        (4)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (4)
...
#define STAI_NETWORK_WEIGHT_3_SIZE        (192)
#define STAI_NETWORK_WEIGHT_3_SIZE_BYTES  (192)
#define STAI_NETWORK_WEIGHT_4_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_4_SIZE        (192)
#define STAI_NETWORK_WEIGHT_4_SIZE_BYTES  (192)
#define STAI_NETWORK_WEIGHT_5_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_5_SIZE        (192)
#define STAI_NETWORK_WEIGHT_5_SIZE_BYTES  (192)
...
#define STAI_NETWORK_WEIGHT_7_SIZE        (192)
#define STAI_NETWORK_WEIGHT_7_SIZE_BYTES  (192)
...
#define STAI_NETWORK_WEIGHT_9_SIZE        (192)
#define STAI_NETWORK_WEIGHT_9_SIZE_BYTES  (192)
#define STAI_NETWORK_WEIGHT_10_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_10_SIZE        (768)
#define STAI_NETWORK_WEIGHT_10_SIZE_BYTES  (768)
#define STAI_NETWORK_WEIGHT_11_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_11_SIZE        (147456)
#define STAI_NETWORK_WEIGHT_11_SIZE_BYTES  (147456)
#define STAI_NETWORK_WEIGHT_12_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_12_SIZE        (3072)
#define STAI_NETWORK_WEIGHT_12_SIZE_BYTES  (3072)
#define STAI_NETWORK_WEIGHT_13_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_13_SIZE        (768)
#define STAI_NETWORK_WEIGHT_13_SIZE_BYTES  (768)
#define STAI_NETWORK_WEIGHT_14_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_14_SIZE        (147456)
#define STAI_NETWORK_WEIGHT_14_SIZE_BYTES  (147456)
#define STAI_NETWORK_WEIGHT_15_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_15_SIZE        (160)
#define STAI_NETWORK_WEIGHT_15_SIZE_BYTES  (160)
#define STAI_NETWORK_WEIGHT_16_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_16_SIZE        (160)
#define STAI_NETWORK_WEIGHT_16_SIZE_BYTES  (160)
#define STAI_NETWORK_WEIGHT_17_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_17_SIZE        (3200)
#define STAI_NETWORK_WEIGHT_17_SIZE_BYTES  (3200)
#define STAI_NETWORK_WEIGHT_18_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_18_SIZE        (640)
#define STAI_NETWORK_WEIGHT_18_SIZE_BYTES  (640)
#define STAI_NETWORK_WEIGHT_19_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_19_SIZE        (4)
#define STAI_NETWORK_WEIGHT_19_SIZE_BYTES  (4)
#define STAI_NETWORK_WEIGHT_20_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_20_SIZE        (4)
#define STAI_NETWORK_WEIGHT_20_SIZE_BYTES  (4)
#define STAI_NETWORK_WEIGHT_21_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_21_SIZE        (25600)
#define STAI_NETWORK_WEIGHT_21_SIZE_BYTES  (25600)
#define STAI_NETWORK_WEIGHT_22_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_22_SIZE        (640)
#define STAI_NETWORK_WEIGHT_22_SIZE_BYTES  (640)
#define STAI_NETWORK_WEIGHT_23_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_23_SIZE        (122880)
#define STAI_NETWORK_WEIGHT_23_SIZE_BYTES  (122880)
#define STAI_NETWORK_WEIGHT_24_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_24_SIZE        (4)
#define STAI_NETWORK_WEIGHT_24_SIZE_BYTES  (4)
#define STAI_NETWORK_WEIGHT_25_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_25_SIZE        (147456)
#define STAI_NETWORK_WEIGHT_25_SIZE_BYTES  (147456)
#define STAI_NETWORK_WEIGHT_26_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_26_SIZE        (4)
#define STAI_NETWORK_WEIGHT_26_SIZE_BYTES  (4)
#define STAI_NETWORK_WEIGHT_27_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_27_SIZE        (4)
#define STAI_NETWORK_WEIGHT_27_SIZE_BYTES  (4)
#define STAI_NETWORK_WEIGHT_28_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_28_SIZE        (36864)
#define STAI_NETWORK_WEIGHT_28_SIZE_BYTES  (36864)
#define STAI_NETWORK_WEIGHT_29_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_29_SIZE        (768)
#define STAI_NETWORK_WEIGHT_29_SIZE_BYTES  (768)
#define STAI_NETWORK_WEIGHT_30_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_30_SIZE        (36864)
#define STAI_NETWORK_WEIGHT_30_SIZE_BYTES  (36864)
#define STAI_NETWORK_WEIGHT_31_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_31_SIZE        (768)
#define STAI_NETWORK_WEIGHT_31_SIZE_BYTES  (768)
#define STAI_NETWORK_WEIGHT_32_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_32_SIZE        (36864)
#define STAI_NETWORK_WEIGHT_32_SIZE_BYTES  (36864)
#define STAI_NETWORK_WEIGHT_33_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_33_SIZE        (768)
#define STAI_NETWORK_WEIGHT_33_SIZE_BYTES  (768)
#define STAI_NETWORK_WEIGHT_34_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_34_SIZE        (36864)
#define STAI_NETWORK_WEIGHT_34_SIZE_BYTES  (36864)
#define STAI_NETWORK_WEIGHT_35_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_35_SIZE        (768)
#define STAI_NETWORK_WEIGHT_35_SIZE_BYTES  (768)
#define STAI_NETWORK_WEIGHT_36_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_36_SIZE        (36864)
#define STAI_NETWORK_WEIGHT_36_SIZE_BYTES  (36864)
#define STAI_NETWORK_WEIGHT_37_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_37_SIZE        (768)
#define STAI_NETWORK_WEIGHT_37_SIZE_BYTES  (768)
#define STAI_NETWORK_WEIGHT_38_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_38_SIZE        (36864)
#define STAI_NETWORK_WEIGHT_38_SIZE_BYTES  (36864)
#define STAI_NETWORK_WEIGHT_39_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_39_SIZE        (768)
#define STAI_NETWORK_WEIGHT_39_SIZE_BYTES  (768)
#define STAI_NETWORK_WEIGHT_40_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_40_SIZE        (36864)
#define STAI_NETWORK_WEIGHT_40_SIZE_BYTES  (36864)
#define STAI_NETWORK_WEIGHT_41_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_41_SIZE        (768)
#define STAI_NETWORK_WEIGHT_41_SIZE_BYTES  (768)
#define STAI_NETWORK_WEIGHT_42_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_42_SIZE        (36864)
#define STAI_NETWORK_WEIGHT_42_SIZE_BYTES  (36864)
#define STAI_NETWORK_WEIGHT_43_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_43_SIZE        (768)
#define STAI_NETWORK_WEIGHT_43_SIZE_BYTES  (768)
#define STAI_NETWORK_WEIGHT_44_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_44_SIZE        (192)
#define STAI_NETWORK_WEIGHT_44_SIZE_BYTES  (192)
#define STAI_NETWORK_WEIGHT_45_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_45_SIZE        (4)
#define STAI_NETWORK_WEIGHT_45_SIZE_BYTES  (4)
