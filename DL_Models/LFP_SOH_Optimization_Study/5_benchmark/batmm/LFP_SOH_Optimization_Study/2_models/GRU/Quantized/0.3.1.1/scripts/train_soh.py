...
def main():
    import argparse
    ap = argparse.ArgumentParser(description='0.3.1.1 SOH Training – Hourly Aggregation + Stats (Seq2Seq, GRU)')
    ...
    print('\n' + '=' * 80)
    print('0.3.1.1 SOH Training – Hourly Aggregation + Stats (Seq2Seq, GRU)')
    print('=' * 80)
