...
def main():
    import argparse
    ap = argparse.ArgumentParser(description='0.1.2.3 SOH Training – Hourly Aggregation + Stats (Seq2Seq, Larger Model)')
    ...
    print('\n' + '=' * 80)
    print('0.1.2.3 SOH Training – Hourly Aggregation + Stats (Seq2Seq, Larger Model)')
    print('=' * 80)
    ...
    print(f'Model: embed={embed_size}, hidden={hidden_size}, layers={num_layers}, res_blocks={res_blocks}, bidir={bidirectional}')
