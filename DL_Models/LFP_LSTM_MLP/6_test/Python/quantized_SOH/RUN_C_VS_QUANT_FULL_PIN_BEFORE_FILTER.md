C vs Quantized (full, PIN before filter, strict)
...
Outputs
- 6_test\Python\quantized_SOH\COMPARE_C_VS_QUANT_STEP_FULL_PIN_BEFORE_FILTER
- 2_models\quantized\manual_int8_lstm_soh_export\quant_state_soh_int8.npz
