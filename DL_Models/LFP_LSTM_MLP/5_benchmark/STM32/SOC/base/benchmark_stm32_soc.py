...
def run_benchmark(port, baud, samples, rate_delay, timeout, outdir, seed=None, data_path=None):
    ...
    # Path relative to STM32/benchmark/SOC_base/
    map_path = os.path.join('..', '..', 'workspace_1.17.0', 'AI_Project_LSTM_SOC_base', 'Debug', 'AI_Project_LSTM_SOC_base.map')
    map_path = os.path.normpath(os.path.join(os.path.dirname(__file__), map_path))
    elf_path = os.path.normpath(os.path.join(os.path.dirname(__file__), '..', '..', 'workspace_1.17.0', 'AI_Project_LSTM_SOC_base', 'Debug', 'AI_Project_LSTM_SOC_base.elf'))
...
if __name__ == '__main__':
    ...
    ap.add_argument('--outdir', default=None, help='Output directory (defaults to DL_Models/LFP_LSTM_MLP/5_benchmark/STM32/SOC/base/results_TIMESTAMP)')
    ...
    if args.outdir is None:
        ...
        base_out = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'DL_Models', 'LFP_LSTM_MLP', '5_benchmark', 'STM32', 'SOC', 'base')
