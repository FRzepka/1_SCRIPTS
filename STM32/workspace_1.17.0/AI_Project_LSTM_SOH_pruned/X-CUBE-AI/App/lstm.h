...
#define AI_LSTM_ORIGIN_MODEL_NAME   "soc_1_5_0_0_streaming_fp32_chunk1_stateless"

/******************************************************************************/
#define AI_LSTM_ACTIVATIONS_ALIGNMENT   (4)
#define AI_LSTM_INPUTS_IN_ACTIVATIONS   (4)
#define AI_LSTM_OUTPUTS_IN_ACTIVATIONS  (4)
...
AI_DEPRECATED
#define AI_LSTM_IN \
  ai_lstm_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_LSTM_IN_SIZE { \
  AI_LSTM_IN_1_SIZE, \
}
#define AI_LSTM_IN_SIZE_BYTES { \
  AI_LSTM_IN_1_SIZE_BYTES, \
}
#define AI_LSTM_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_LSTM_IN_1_HEIGHT      (1)
#define AI_LSTM_IN_1_CHANNEL     (6)
#define AI_LSTM_IN_1_SIZE        (6)
#define AI_LSTM_IN_1_SIZE_BYTES  (24)
...
AI_DEPRECATED
#define AI_LSTM_OUT \
  ai_lstm_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_LSTM_OUT_SIZE { \
  AI_LSTM_OUT_1_SIZE, \
}
#define AI_LSTM_OUT_SIZE_BYTES { \
  AI_LSTM_OUT_1_SIZE_BYTES, \
}
#define AI_LSTM_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_LSTM_OUT_1_CHANNEL     (1)
#define AI_LSTM_OUT_1_SIZE        (1)
#define AI_LSTM_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_LSTM_N_NODES (7)
