...
/* ULTRA-FRÜH: LED1 anschalten BEVOR SystemInit! */
  ldr r0, =0x58024400      /* RCC_AHB4ENR address */
  ldr r1, [r0]
  orr r1, r1, #0x02        /* Set GPIOBEN bit */
  str r1, [r0]
  
  ldr r0, =0x58020400      /* GPIOB_MODER address */
  ldr r1, [r0]
  bic r1, r1, #0x3         /* Clear MODER0 */
  orr r1, r1, #0x1         /* Set MODER0 to output */
  str r1, [r0]
  
  ldr r0, =0x58020418      /* GPIOB_BSRR address */
  mov r1, #0x1             /* Set BS0 */
  str r1, [r0]             /* LED1 AN!!! */
